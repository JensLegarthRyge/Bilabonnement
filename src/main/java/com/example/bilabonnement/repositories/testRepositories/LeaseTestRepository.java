...
public class LeaseTestRepository implements CRUDInterface<LeaseReport> {
    ...
    ArrayList<LeaseReport> allLeaseReports = new ArrayList<>(
            Arrays.asList(
                    new LeaseReport(1, 2, 3, 2,3,
                            idag, 120, true, true, "Vølundsgade 29", false, 12999, idag),
                    new LeaseReport(2, 4, 578, 3,3,
                            idag, 120, true, false, "Kirkeskovsstræde 339, 1. TH", false, 12999, idag),
                    new LeaseReport(7643, 5, 3, 1,1,
                            idag, 120, true, true, "Kovej 29", false, 12999, idag),
                    new LeaseReport(1, 6, 3, 2,2,
                            idag, 120, true, true, "Vølundsgade 29", false, 12999, idag),
                    new LeaseReport(2, 7, 578, 3,4,
                            idag, 120, true, false, "Kirkeskovsstræde 339, 1. TH", false, 12999, idag),
                    new LeaseReport(7643, 9, 3, 1,3,
                            idag, 120, true, true, "Kovej 29", false, 12999, idag),
                    new LeaseReport(1, 10, 3, 2,6,
                            idag, 120, true, true, "Vølundsgade 29", false, 12999, idag),
                    new LeaseReport(2, 11, 578, 3,7,
                            idag, 120, true, false, "Kirkeskovsstræde 339, 1. TH", false, 12999, idag),
                    new LeaseReport(7643, 12, 3, 1,8,
                            idag, 120, true, true, "Kovej 29", false, 12999, idag),
                    new LeaseReport(1, 13, 3, 2,9,
                            idag, 120, true, true, "Vølundsgade 29", false, 12999, idag),
                    new LeaseReport(2, 14, 578, 3,10,
                            idag, 120, true, false, "Kirkeskovsstræde 339, 1. TH", false, 12999, idag),
                    new LeaseReport(7643, 15, 3, 1,11,
                            idag, 120, true, true, "Kovej 29", false, 12999, idag),
                    new LeaseReport(1, 15, 3, 2,13,
                            idag, 120, true, true, "Vølundsgade 29", false, 12999, idag),
                    new LeaseReport(2, 13, 578, 3,12,
                            idag, 120, true, false, "Kirkeskovsstræde 339, 1. TH", false, 12999, idag),
                    new LeaseReport(7643, 12, 3, 1,1,
                            idag, 120, true, true, "Kovej 29", false, 12999, idag),
                    new LeaseReport(1, 12, 3, 2,15,
                            idag, 120, true, true, "Vølundsgade 29", false, 12999, idag),
                    new LeaseReport(2, 14, 578, 3,16,
                            idag, 120, true, false, "Kirkeskovsstræde 339, 1. TH", false, 12999, idag),
                    new LeaseReport(7643, 19, 3, 1,19,
                            idag, 120, true, true, "Kovej 29", false, 12999, idag),
                    new LeaseReport(1, 20, 3, 2,21,
                            idag, 120, true, true, "Vølundsgade 29", false, 12999, idag),
                    new LeaseReport(2, 21, 578, 3,22,
                            idag, 120, true, false, "Kirkeskovsstræde 339, 1. TH", false, 12999, idag),
                    new LeaseReport(7643, 22, 3, 1,23,
                            idag, 120, true, true, "Kovej 29", false, 12999, idag),
                    new LeaseReport(1, 23, 3, 2,24,
                            idag, 120, true, true, "Vølundsgade 29", false, 12999, idag),
                    new LeaseReport(2, 24, 578, 3,25,
                            idag, 120, true, false, "Kirkeskovsstræde 339, 1. TH", false, 12999, idag),
                    new LeaseReport(7643, 25, 3, 1,26,
                            idag, 120, true, true, "Kovej 29", false, 12999, idag)
            )
    );
